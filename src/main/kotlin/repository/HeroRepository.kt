...
@Serializable
class HeroRepository: HeroRepo {
    // By lazy because they are declared below 😅
    ...
    override suspend fun getAllHeroes(page: Int): ApiResponse {
        return ApiResponse(
            success = true,
            message = "Ok for page number: $page",
            prevPage = if (page > 1) page - 1 else null,
            nextPage = if (page < 5) page + 1 else null,
            heroes = heroes[page]!!, // !! because the value will not be null,
        )
    }
